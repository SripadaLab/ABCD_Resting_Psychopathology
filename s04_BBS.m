...
results_p_perms = mc_bbs_perm(featuremat,mainpheno,nuisance,folds,NumComp,Perms,'Scores',results_p.Aa,'LOSOPheno',0);

%%
%now run 10k perms with expanded nuisance
results_p_full_perms = mc_bbs_perm(featuremat,mainpheno(:,1),nuisancefull,folds,NumComp,Perms,'Scores',results_p.Aa,'LOSOPheno',0);

%%
%now run 10k perms with drop site p
results_p_losop_perms = mc_bbs_perm(featuremat,losopheno,nuisancefull,folds,NumComp,Perms,'Scores',results_p.Aa,'LOSOPheno',1);
